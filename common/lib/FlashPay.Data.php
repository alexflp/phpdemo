...
class FlashPayDataBase
{
    ...
    {
        $buff = "";
        $buff .= FlashPayConfig::PARTNER_CODE . '&' . $this->getTime() . '&' . $this->getNonceStr() . "&" . FlashPayConfig::CREDENTIAL_CODE;
        return $buff;
    }
 ...
 * @author Leijid
 */
class FlashPayMicropayOrder extends FlashPayUnifiedOrder
{
    /**
     * 设置设备ID
     * @param string $value
 ...
 * 线下QRCode支付单
 */
class FlashPayRetailQRCode extends FlashPayUnifiedOrder
{
    /**
     * 设置设备ID
     * @param string $value
 ...
 * @author Leijid
 */
class FlashPayOrderQuery extends FlashPayDataBase
{
    /**
     * 设置商户支付订单号，同一商户唯一
     * @param string $value
 ...
 * @author Leijid
 */
class FlashPayApplyRefund extends FlashPayDataBase
{
    /**
     * 设置商户支付订单号，同一商户唯一
     * @param string $value
 ...
 * @author Leijid
 */
class FlashPayQueryRefund extends FlashPayDataBase
{
    /**
     * 设置商户支付订单号，同一商户唯一
     * @param string $value
 ...
 * @author Leijid
 */
class FlashPayQueryOrders extends FlashPayDataBase
{
    /**
